...
where P(diabetes) is the probability of the individual having diabetes given their other features.",
           ...
           br(),"These paremeters were chosen because the patients have an idea about these features",
  ...
  tabPanel("Observation",
           ...
           tags$h3("Observation"),
           br(),
           ("Random Forest was chosen because of its ability to classify and using the best possible selection of the parameters"),
           tags$p("My first choice to fix this issue was to smote classify and create duplicates for the the lower number of Diabetes and No diabetes. However, on Doing so, the size of the data increased ginormously.",
